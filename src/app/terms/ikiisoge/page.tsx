...
export const metadata: Metadata = {
  title: "利用規約 | 生き急げ！",
  description: "iOSアプリ「生き急げ！」の利用規約",
};

export default function IkiisougeTermsPage() {
  return (
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm text-[#a3a3a3] leading-relaxed">
          ...
          <section>
            ...
            <p>本規約は、個人開発者 Naoto（以下「開発者」）が提供するiOSアプリ「生き急げ！」（以下「本アプリ」）の利用に関する条件を定めるものです。本アプリを利用した時点で、本規約に同意したものとみなします。</p>
          </section>
          ...
          <section>
            <h2 className="text-[#f5f5f5] font-semibold mb-2">第4条（SNS共有機能について）</h2>
            <p>本アプリにはSNSへの投稿を補助する共有機能があります。共有される内容はユーザー自身が入力・選択したものであり、共有先のSNSプラットフォームの利用規約が適用されます。開発者は共有されたコンテンツについて一切の責任を負いません。</p>
          </section>

          <section>
            <h2 className="text-[#f5f5f5] font-semibold mb-2">第5条（免責事項）</h2>
            <p>本アプリの利用により生じたいかなる損害についても、開発者は責任を負いません。また、予告なくアプリの内容を変更・停止する場合があります。</p>
          </section>
